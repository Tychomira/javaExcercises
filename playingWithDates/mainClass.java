...
public class mainClass {
    ...
    public static void main(String[] args) {
        ...
        String name1=bootcamp.getName();
        LocalDate end_date=bootcamp.getEndingDate();
        LocalDate start_date=bootcamp.getStartingDate();
                
        System.out.println("Now Please enter a date:");
        LocalDate enteringDate = enteringDate();

  boolean  isThereABootcamp = (enteringDate).isBefore(start_date) && (enteringDate).isBefore(end_date);

       if (isThereABootcamp) {
          System.out.println(name1 + ", is available in " + enteringDate + ".It starts in " + start_date + ", and it ends in " + end_date);
       
       }
       
       else  
       {System.out.println("Unfortunatelly wee don't have any courses for the date you entered!");
       }
